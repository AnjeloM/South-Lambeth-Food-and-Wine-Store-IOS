...
public struct WelcomeUiState: Equatable {
    ...
    """
    Want to get store 
    inventory? An app that 
    makes your inventory 
    process faster and 
    easier
    """
    ...
    public var brandNormal3: String =
    """
    Inventory App will help you add items to your inventory by scanning the barcode or searching by name with fast and easy steps, and export a final PDF format that can be printed easily.
    """
